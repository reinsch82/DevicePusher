...
#ifndef __NativePusher_i_h__
#define __NativePusher_i_h__
...
#ifndef __NativePusherLib_LIBRARY_DEFINED__
#define __NativePusherLib_LIBRARY_DEFINED__

/* library NativePusherLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_NativePusherLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("3738C177-5750-4502-89EC-0C61E5EB2316")
CompReg;
#endif
#endif /* __NativePusherLib_LIBRARY_DEFINED__ */
