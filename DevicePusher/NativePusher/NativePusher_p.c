...
typedef struct _NativePusher_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } NativePusher_MIDL_TYPE_FORMAT_STRING;

typedef struct _NativePusher_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } NativePusher_MIDL_PROC_FORMAT_STRING;

typedef struct _NativePusher_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } NativePusher_MIDL_EXPR_FORMAT_STRING;
...
extern const NativePusher_MIDL_TYPE_FORMAT_STRING NativePusher__MIDL_TypeFormatString;
extern const NativePusher_MIDL_PROC_FORMAT_STRING NativePusher__MIDL_ProcFormatString;
extern const NativePusher_MIDL_EXPR_FORMAT_STRING NativePusher__MIDL_ExprFormatString;
...
static const NativePusher_MIDL_PROC_FORMAT_STRING NativePusher__MIDL_ProcFormatString =
    {
        0,
        {
...
static const NativePusher_MIDL_TYPE_FORMAT_STRING NativePusher__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    NativePusher__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    NativePusher__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _NativePusher_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _NativePusher_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _NativePusher_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  const _NativePusher_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _NativePusher_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _NativePusher, pIID, n)

int __stdcall _NativePusher_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_NativePusher_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo NativePusher_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _NativePusher_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _NativePusher_StubVtblList,
    (const PCInterfaceName * ) & _NativePusher_InterfaceNamesList,
    (const IID ** ) & _NativePusher_BaseIIDList,
    & _NativePusher_IID_Lookup, 
    1,
    2,
